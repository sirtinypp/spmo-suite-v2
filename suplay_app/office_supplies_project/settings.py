...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-fallback-key-for-local-dev-stability')
...
# --- SURGICAL ENV LOADING (FOR LOCAL DEV STABILITY) ---
# Try to load .env from parent directory if running locally
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'supplies.context_processors.sidebar_pulse',
            ],
        },
    },
]
