...
urlpatterns = [
    ...
    path(
        ...
        auth_views.LoginView.as_view(
            template_name="supplies/login.html", next_page="home"
        ),
        name="login",
    ),
    ...
    path(
        "checkout/finalize/<int:order_id>/",
        views.checkout_finalize,
    ...
    path(
        "delivery/confirm/<int:order_id>/", views.mark_delivered, name="mark_delivered"
    ),
    ...
    path(
        "requisition-slip/<int:order_id>/",
        views.requisition_slip,
        name="requisition_slip_download",
    ),
