...
urlpatterns = [
    ...
    path('emergency-registry/', views.emergency_registry, name='emergency_registry'),
    path('emergency-registry/export/', views.export_emergency_registry, name='export_emergency_registry'),
