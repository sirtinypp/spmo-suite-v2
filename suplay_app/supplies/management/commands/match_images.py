...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for product in products:
            ...
            for ext in ['.jpg', '.jpeg', '.png', '.JPG', '.JPEG', '.PNG']:
                ...
                if os.path.exists(file_path):
                    ...
                    product.save()
                    self.stdout.write(self.style.SUCCESS(f"Matched: {code} -> {filename}"))
                    matched_count += 1
                    found = True
                    break
        ...
        self.stdout.write(self.style.SUCCESS(f"Done! Matched {matched_count} images out of {total_products} products with item codes."))
