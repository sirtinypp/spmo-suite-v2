...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Found {len(image_files)} image files in {media_dir}'))
        ...
        for filename in image_files:
            ...
            try:
                ...
                self.stdout.write(self.style.WARNING(f'✗ No product found for item_code: {item_code}'))
            except Product.MultipleObjectsReturned:
                self.stdout.write(self.style.ERROR(f'✗ Multiple products found for item_code: {item_code}'))
