...
class Asset(models.Model):
    ...
    ASSET_TYPE_CHOICES = [
        ...
        ('DESKTOPS_AND_ALL-IN-ONE_PCS', 'Desktops & All-in-one PCs'),
        ...
        ('MONITOR_AND_DISPLAY_DEVICES', 'Monitor & Display Devices'),
        ('NETWORK_AND_SECURITY_DEVICES', 'Network & Security Devices'),
