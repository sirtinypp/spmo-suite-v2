...
class UserProfile(models.Model):
    ...
    office = models.CharField(max_length=100, choices=OFFICE_CHOICES, blank=True, null=True, verbose_name="Assigned Office")
...
class BookingRequest(models.Model):
    ...
    unit_office = models.CharField(max_length=100, choices=OFFICE_CHOICES, verbose_name="Unit Office")
    mother_unit = models.CharField(max_length=100, choices=MOTHER_UNIT_CHOICES, verbose_name="Mother Unit")
