...
class BookingRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = [
            'status', 'created_at', 
            'doc_signed_slip', 'doc_travel_order', 'doc_gov_id', 'doc_itinerary', 'doc_previous_gfa',
            'booking_reference_no', 'doc_flight_ticket', 'doc_voucher', 'admin_instructions', 'ticket_issued_at'
        ]
...
class BookingUploadForm(forms.ModelForm):
    class Meta:
        model = BookingRequest
        fields = ['doc_signed_slip', 'doc_travel_order', 'doc_gov_id', 'doc_itinerary', 'doc_previous_gfa']
...
class AdminBookingForm(forms.ModelForm):
    class Meta:
        model = BookingRequest
        fields = ['booking_reference_no', 'total_amount', 'doc_flight_ticket', 'doc_voucher', 'admin_instructions']
