...
(function () {
    ...
    // Logout immediately using a POST request for Django 5.x compatibility
    function logoutNow() {
        console.log('[log] Session expired. Performing secure auto-logout...');

        // Create a hidden form to perform a POST logout
        ...
        if (csrfToken) {
            ...
            // Fallback for pages without a form/CSRF token visible
            console.warn('[warn] CSRF token not found. Attempting logout without token...');
        }
