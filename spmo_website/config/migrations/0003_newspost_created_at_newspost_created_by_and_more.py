...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='newspost',
            name='image',
            field=models.ImageField(blank=True, help_text='Card thumbnail image', null=True, upload_to='news_images/'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_name', models.CharField(help_text='e.g., College of Engineering', max_length=200)),
                ('activity', models.CharField(help_text='e.g., Physical Inventory Count', max_length=200)),
