...
with open('gfa_app/travel/templates/travel/form.html', 'w', encoding='utf-8', newline='\r\n') as f:
    f.write(content)
...
with open('gfa_app/travel/templates/travel/dashboard.html', 'w', encoding='utf-8', newline='\r\n') as f:
    f.write(content)
